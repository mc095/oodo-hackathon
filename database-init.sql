-- ExpenseFlow Database Initialization Script
...
-- Create expense_approval_requests table
...
INSERT IGNORE INTO companies (id, name, currency, country) 
VALUES ('default-company-id', 'Default Company', 'USD', 'US');

-- Insert default admin user
INSERT IGNORE INTO users (id, name, email, role, company_id) 
VALUES ('default-admin-id', 'Admin User', 'admin@expenseflow.com', 'Admin', 'default-company-id');

-- Show success message
SELECT 'Database initialized successfully!' as message;
SELECT 'Default admin user created: admin@expenseflow.com' as admin_info;
